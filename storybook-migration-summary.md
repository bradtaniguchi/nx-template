...
- `npx storybook@latest automigrate --config-dir libs/common-react/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir libs/storybook/.storybook --renderer @storybook/react`
